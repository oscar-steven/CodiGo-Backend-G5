...
export class ProductoService {
  ...
  static async devolverProducto(id) {
    ...
    if (producto === undefined) {
      return { message: `No existe el producto con el id ${id}` };
    }
  ...
  static async listarProductos() {
    ...
    const productosIterados = productos.map((producto) => {
      return {
        ...
        // el operador Logical OR (||) es si el primero es falso, undefined o null pasara a validar el segundoi, si ese tbn es de alguno de esos valores su contenido sera nulo, caso contrario tomara el primero o el segundo
        // nullish coalescing operato(??) si el primer valor no es nulo o undefined tomara el primer valor caso contrario tomara el segundo valor
