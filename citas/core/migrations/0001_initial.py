# Generated by Django 4.0.1 on 2022-01-15 21:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personaEstadoCivil', models.CharField(choices=[('SOLTERO', 'SOLTERO'), ('CASADO', 'CASADO'), ('DIVORCIADO', 'DIVORCIADO'), ('VIUDO', 'VIUDO'), ('COMPLICADO', 'COMPLICADO'), ('NO_ESPECIFICA', 'NO_ESPECIFICA')], db_column='estado_civil', default='NO_ESPECIFICA', max_length=50)),
                ('personaFoto', models.ImageField(db_column='foto', null=True, upload_to='personas/')),
            ],
            options={
                'db_table': 'personas',
                'ordering': ['-personaEmail', 'personaApellido'],
            },
        ),
        migrations.CreateModel(
            name='CitasModel',
