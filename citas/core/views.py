...
class PersonasController(CreateAPIView):
    # sera el encargado de moldear la informacion que nos llega a nuestro backend y a su vez de formatear la informacion para que pueda ser enviada al front
