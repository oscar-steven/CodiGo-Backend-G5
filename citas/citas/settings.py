...
# buscara el archivo .env en nuestro proyecto y si lo encuentra configurara para python las variables de entorno en ese archivo
load_dotenv()
...
SECRET_KEY = 'django-insecure-70r9+gqg8q_z6$a6rkio(fy=*&3u=6tmjhkjpb$xmuydli*&%z'
