...
fetch("http://127.0.0.1:5000/productos", {
  ...
  // los header sirven para indicar al backend varias opciones para la transferencia de informacion como el Content-Type que servira para indicar que tipo de contenido estamos enviando mediante el body
  headers: {
